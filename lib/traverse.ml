module type STREAM = Traverse_intf.Traversable.STREAM
module type IDIOM = Traverse_intf.Traversable.IDIOM
...
(* TODO: abstract over container datatypes other than lists;
   Haskell handwaves this a bit *)
